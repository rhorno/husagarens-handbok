...
## Översikt
Skadedjur är ett samlingsnamn för djur som kan orsaka skador på egendom, sprida smitta eller ge upphov till obehag och olägenhet för människors hälsa – exempelvis råttor, möss, fåglar, fladdermöss och vissa insekter som getingar och husbock.[^1] Det är därför skydd mot skadedjur regleras särskilt i de svenska byggreglerna, som ställer krav på att byggnader ska utformas så att det försvåras för skadedjur att ta sig in i dem.[^2] Som husägare möter du i praktiken två typer av problem: dels gnagare och insekter som söker sig in i huset för mat, vatten och skydd (möss, råttor, myror, getingar), dels virkeslevande insekter som husbock och hästmyra som direkt kan skada husets bärande konstruktion.[^3] Ansvaret för att hålla en bostad fri från skadedjur vilar enligt miljöbalken på fastighetsägaren, oavsett om det är ett villahushåll, en bostadsrättsförening eller en hyresvärd.[^4] God förebyggande tätning, tidig upptäckt och rätt val av bekämpningsmetod är avgörande – dels för att undvika kostsamma skador, dels för att många kraftfulla bekämpningsmedel numera är förbehållna yrkesmässiga användare med särskilt tillstånd.[^5]
...
Vid getingbo nära huset är huvudregeln att låta boet vara ifred om det inte stör, eftersom getingar är nyttodjur som håller efter andra skadeinsekter.[^11] Är boet litet och lättåtkomligt kan det i vissa fall avlägsnas försiktigt själv, till exempel tidigt på säsongen[^11], men är boet stort eller sitter det svåråtkomligt är det en risk att försöka ta bort det på egen hand – då bör du i stället anlita en skadedjurstekniker, eftersom getingar kan bli aggressiva när boet störs.[^34]

Vid misstanke om husbock eller andra virkeslevande insekter är snabb identifiering avgörande: leta efter ovala flyghål (ofta 5–8 mm, med oregelbundna kanter), ljust, jämnt sågspån och eventuellt en skrapande gnagljud från vinden på varma sommardagar, eftersom vuxna husbockar flyger och kan sprida sig vidare till andra byggnader vid temperaturer över 25 grader, vilket gör att spridningsrisken ökar under mycket varma somrar.[^30] Misstänker du angrepp bör du kontakta ditt försäkringsbolag eller en bekämpningsfirma direkt, eftersom skadan annars riskerar att växa och bli dyrare att åtgärda.[^26]
...
32. [If — Skadedjurssanering ingår i försäkringen](https://www.if.se/privat/vid-skada/hus-hem/skadedjurssanering)
33. [Folksam — Skadedjur (hemförsäkring)](https://www.folksam.se/forsakringar/hemforsakring/skadedjur)
34. [Folksam — Getingar, tips och råd](https://www.folksam.se/forsakringar/hemforsakring/skadedjur/getingar)
